...
C {gf180mcuc-stdcells/dffq_2.sym} 190 -370 0 0 {name=x2 VDD=VDD VNW=VNW VPW=VPW VSS=VSS prefix=gf180mcu_fd_sc_mcu7t5v0__ }
...
C {lab_wire.sym} 960 -220 0 1 {name=p14 sig_type=std_logic lab=and2
}
...
C {lab_wire.sym} 730 -240 0 0 {name=p15 sig_type=std_logic lab=A1}
C {lab_wire.sym} 730 -200 0 0 {name=p16 sig_type=std_logic lab=A2}
...
C {gf180mcuc-stdcells/inv_2.sym} 510 -360 0 0 {name=x8 VDD=VDD VNW=VNW VPW=VPW VSS=VSS prefix=gf180mcu_fd_sc_mcu7t5v0__ }
...
C {lab_wire.sym} 580 -360 0 1 {name=p27 sig_type=std_logic lab=i2}
C {lab_wire.sym} 440 -360 0 0 {name=p28 sig_type=std_logic lab=A1}
...
C {lab_wire.sym} 100 -380 0 0 {name=p66 sig_type=std_logic lab=CLK}
C {lab_wire.sym} 340 -380 0 1 {name=p67 sig_type=std_logic lab=q2}
C {lab_wire.sym} 100 -360 0 0 {name=p68 sig_type=std_logic lab=D2}
C {code_shown.sym} -280 -270 0 0 {name=NGSPICE1 only_toplevel=false value="
.tran 1n 320n
.save all"}
C {gnd.sym} 830 -140 0 0 {name=l8 lab=GND}
C {lab_wire.sym} 820 -320 0 0 {name=p3 sig_type=std_logic lab=VDD1}
C {lab_wire.sym} -730 -60 0 0 {name=p4 sig_type=std_logic lab=VDD1}
C {vsource.sym} -730 -30 0 0 {name=V8 value=3.3 savecurrent=false}
C {gnd.sym} -730 0 0 0 {name=l9 lab=GND
value=3.3}
C {gf180mcuc-stdcells/or2_2.sym} 820 -220 0 0 {name=x4 VDD=VDD VNW=VNW VPW=VPW VSS=VSS prefix=gf180mcu_fd_sc_mcu7t5v0__ }
